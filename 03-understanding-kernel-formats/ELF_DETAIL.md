...
The first 4 bytes are the offset into the `.shstrtab`, giving the name `.riscv.attributes`. The next 4 bytes are the identifier for a RISCV\_ATTRIBUTE type: `0x70000003`.
